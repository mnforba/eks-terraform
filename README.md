...
### Install Terraform
``` sh
$ git clone https://github.com/mnforba/terraform-provision-eks.git
...
$ source ~/.bashrc  
# run the scripts https://github.com/mnforba/terraform-provision-eks/blob/main/terraform-install.sh
